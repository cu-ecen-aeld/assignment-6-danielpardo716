...
SRC_URI = "git://git@github.com/cu-ecen-aeld/assignments-3-and-later-danielpardo716.git;protocol=ssh;branch=main"
PV = "1.0+git${SRCPV}"
SRCREV = "77ec9720cf427320112fd4704899fc680fb80cfd"
